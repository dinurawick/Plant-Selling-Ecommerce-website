...
<head>
    ...
    <title>Plantaholics | BromLiad Summer</title>
...
<!---------------------Products----------------------->
            ...
            <div class="small-container details">
               <div class="row">
                 <div class="col-2">
                 <img src="../images/bromeliadtillandsia-summer_charcoal.jpeg" width="80%" id="ProductImg">
              
<!------------------Mini Images------------->              
             
                 <div class="miniimages">
                    <div class="mini-img-col">
                        <img src="../images/bromeliadtillandsia-summer_charcoal.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                    </div>
                     <div class="mini-img-col">
                       <img src="../images/brom.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                      </div>
                  </div>
            </div>

              <div class="col-6">
                  <h2>Bromeliad Summer</h2>
