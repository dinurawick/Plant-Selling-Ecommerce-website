...
<head>
    ...
    <title>Plantaholics | Phalanopsis Orchid White</title>
...
<!---------------------Products----------------------->
            ...
            <div class="small-container details">
               <div class="row">
                 <div class="col-2">
                 <img src="../images/phalwhite.jpeg" width="80%" id="ProductImg">
              
<!------------------Mini Images---------------->              
             
                 <div class="miniimages">
                    <div class="mini-img-col">
                        <img src="../images/phalwhite.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                    </div>
                     <div class="mini-img-col">
                       <img src="../images/phal2.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                     </div>
                     <div class="mini-img-col">
                       <img src="../images/phal3.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                     </div>
                  </div>
            </div>

              <div class="col-6">
                  <h2>Phalanopsis Orchid White</h2>
...
<!----------------------Recommended---------------------->
        ...
        <div class="small-container">
            ...
            <div class="row">
                <div class="col-4">
                  <a href="moneytree.php">  
                    <img src="../images/moneytree.jpeg">
                    <h4>Money Tree</h4>
                    <p>Rs. 1500.00</p>
                  </a>
                ...
                <div class="col-4">
                   <a href="summer.php">
                       <img src="../images/bromeliadtillandsia-summer_charcoal.jpeg">
                       <h4> BromLiad Summer</h4>
                    <p>Rs. 600.00</p>
                   </a> 
                   <a href="" class="button4">Add to Cart</a>
                </div>
