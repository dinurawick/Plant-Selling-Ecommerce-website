...
<head>
    ...
    <title>Plantaholics | Mini-Money Tree</title>
...
<!---------------------Products----------------------->
            ...
            <div class="small-container details">
               <div class="row">
                 <div class="col-2">
                 <img src="../images/mini money.jpg" width="80%" id="ProductImg">
              
<!------------------Mini Images------------->              
             
                 <div class="miniimages">
                    <div class="mini-img-col">
                        <img src="../images/mini money.jpg" width="80%" class="small-img" style="border-radius: 60%;">
                    </div>
                     <div class="mini-img-col">
                       <img src="../images/minimoneytree2.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                      </div>
                  </div>
            </div>
