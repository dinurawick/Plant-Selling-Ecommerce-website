...
<head>
    ...
    <title>Plantaholics | Philodendrum Heartleaf</title>
...
<!---------------------Products----------------------->
            ...
            <div class="small-container details">
               <div class="row">
                 <div class="col-2">
                 <img src="../images/philodendrum_heartleaf1.jpeg" width="80%" id="ProductImg">
              
<!------------------Mini Images------------->              
             
                 <div class="miniimages">
                    <div class="mini-img-col">
                        <img src="../images/philodendrum_heartleaf1.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                    </div>
                     <div class="mini-img-col">
                       <img src="../images/philodendrum_heartleaf.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                      </div>
                  </div>
            </div>

              <div class="col-6">
                  <h2>Philodendrum Heartleaf</h2>
