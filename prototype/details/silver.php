...
<head>
    ...
    <title>Plantaholics | Silver Pothos</title>
...
<!---------------------Products----------------------->
            ...
            <div class="small-container details">
               <div class="row">
                 <div class="col-2">
                 <img src="../images/silversatinpothos.jpg" width="80%" id="ProductImg">
              
<!------------------Mini Images------------->              
             
                 <div class="miniimages">
                    <div class="mini-img-col">
                        <img src="../images/silversatinpothos.jpg" width="80%" class="small-img" style="border-radius: 60%;">
                    </div>
                     <div class="mini-img-col">
                       <img src="../images/silverpothos.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                      </div>
                  </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                  <a href="moneytree.php">  
                      <img src="../images/money_tree.jpeg">
                      <h4>Money Tree</h4>
                    <p>Rs. 1500.00</p>
                  </a> 
                  <a href="" class="button4">Add to Cart</a>
