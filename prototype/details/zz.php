...
<head>
    ...
    <title>Plantaholics | ZZ Plant</title>
...
<!---------------------Products----------------------->
            ...
            <div class="small-container details">
               <div class="row">
                 <div class="col-2">
                 <img src="../images/zzplant3.jpeg" width="80%" id="ProductImg">
              
<!------------------Mini Images------------->              
             
                 <div class="miniimages">
                    <div class="mini-img-col">
                        <img src="../images/zzplant3.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                    </div>
                     <div class="mini-img-col">
                       <img src="../images/zzplants.jpeg" width="80%" class="small-img" style="border-radius: 60%;">
                      </div>
                     <div class="mini-img-col">
                       <img src="../images/zz.jpg" width="80%" class="small-img" style="border-radius: 60%;">
                      </div>
                  </div>
            </div>

              <div class="col-6">
                  <h2>Zamioculcas Zamiifolia</h2>
